...
using Sos.CRM.Infrastructure.Extensions;
...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Sos CRM API", Version = "v1" });
        c.AddServer(new OpenApiServer { Url = "http://localhost:61938" });
