...
/// <summary>
/// Позиция в чеке — один товар с количеством и ценой.
/// </summary>
public class SaleItem : Entity<Guid>
{
    /// <summary>
    /// ID родительской продажи
    /// </summary>
    ...
    /// <summary>
    /// Итого по позиции (цена × кол-во − скидка)
    /// </summary>
    ...
    /// <summary>
    /// Увеличить количество (при добавлении того же товара)
    /// </summary>
