...
builder.Services.AddMediatR(cfg =>
    cfg.RegisterServicesFromAssembly(typeof(CreatePriceRuleCommand).Assembly));
...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Sos Pricing API", Version = "v1" });
        c.AddServer(new OpenApiServer { Url = "http://localhost:62146" });
